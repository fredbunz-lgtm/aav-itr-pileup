...
def detect_itrs_in_sequence(seq, record_id, min_score=180):
    """
    Adapted from itr_detection.py analyze_fasta(), but works directly
    ...
    for ref_name, ref_seq in ITR_REFS.items():
        for aln in aligner.align(ref_seq, seq2):
            ...
            # itr_detection.py versions may return either:
    ...
    for i, hit in enumerate(hits, start=1):
        ...
        # itr_detection.py versions may return:
        #   None/empty
